...
export class Backend implements backendInterface {
    ...
    async addPipeline(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPipeline(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllPipelines(): Promise<Array<PipelineItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPipelines();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetToDefault(arg0: Array<PipelineItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetToDefault(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePipeline(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePipeline(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
